...
export const MarketplaceListing = ClassifiedListing
export type MarketplaceListing = typeof MarketplaceListing
export const DraftMarketplaceListing = DraftClassifiedListing
export type DraftMarketplaceListing = typeof DraftMarketplaceListing
export const MarketplaceShippingOption = 30406
export type MarketplaceShippingOption = typeof MarketplaceShippingOption
export const MarketplaceAuction = 30421
export type MarketplaceAuction = typeof MarketplaceAuction
export const MarketplaceAuctionBid = 1023
export type MarketplaceAuctionBid = typeof MarketplaceAuctionBid
export const MarketplaceAuctionComplete = 1024
export type MarketplaceAuctionComplete = typeof MarketplaceAuctionComplete
export const CommitAuthorization = 1328
export type CommitAuthorization = typeof CommitAuthorization
export const TradeKeyAuthorization = 1329
export type TradeKeyAuthorization = typeof TradeKeyAuthorization
export const StructuredMessage = 1327
export type StructuredMessage = typeof StructuredMessage
export const MarketplacePaymentMethod = 17388
export type MarketplacePaymentMethod = typeof MarketplacePaymentMethod
export const MarketplaceSeed = 1330
export type MarketplaceSeed = typeof MarketplaceSeed
export const ArbitrationServiceSelection = 30302
export type ArbitrationServiceSelection = typeof ArbitrationServiceSelection
export const ArbitrationService = 30303
export type ArbitrationService = typeof ArbitrationService
export const MarketplaceOrder = 32122
export type MarketplaceOrder = typeof MarketplaceOrder
export const MarketplacePayment = 32123
export type MarketplacePayment = typeof MarketplacePayment
export const MarketplacePaymentAck = 32124
export type MarketplacePaymentAck = typeof MarketplacePaymentAck
export const MarketplacePaymentSettlement = 32125
export type MarketplacePaymentSettlement = typeof MarketplacePaymentSettlement
export const MarketplaceOrderCancel = 32126
export type MarketplaceOrderCancel = typeof MarketplaceOrderCancel
export const MarketplacePaymentNack = 32127
export type MarketplacePaymentNack = typeof MarketplacePaymentNack
export const MarketplaceReview = 31555
export type MarketplaceReview = typeof MarketplaceReview
