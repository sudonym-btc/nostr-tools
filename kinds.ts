...
export const EscrowMethod = 17388
export type EscrowMethod = typeof EscrowMethod
export const MarketplaceSeed = 1330
export type MarketplaceSeed = typeof MarketplaceSeed
export const HostrSeed = MarketplaceSeed
export type HostrSeed = typeof HostrSeed
